...
public class Browser implements Comparable<Browser> {
   ...
   * @param version Short version number (eg 7)
  ...
  public String getKey() {
    if (key == null) {
      ...
      String browserKey =
          os + "_" + device + "_" + deviceOrientation + "_" + name + "_" + longVersion;
  ...
  public boolean equals(Object object) {
    ...
    return (key == null ? browser.key == null : key.equals(browser.key))
        && (browserName == null
            ...
            : browserName.equals(browser.browserName))
